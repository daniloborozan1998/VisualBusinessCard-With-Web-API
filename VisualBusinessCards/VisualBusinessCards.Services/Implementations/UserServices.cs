...
using VisualBusinessCards.Shared;
using VisualBusinessCards.Shared.CustomException;

namespace VisualBusinessCards.Services.Implementations
{
    public class UserServices : IUserServices
    {
        ...
        public void Register(RegisterUsersDto registerUserDto)
        {
        ...
        public string Login(LoginDtos loginDto)
        {
            MD5CryptoServiceProvider mD5CryptoServiceProvider = new MD5CryptoServiceProvider();
        ...
        private void ValidateUser(RegisterUsersDto registerUserDto)
        {
